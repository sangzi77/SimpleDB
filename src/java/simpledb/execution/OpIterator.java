 ...
 */
  boolean hasNext() throws DbException, TransactionAbortedException, IOException;
   ...
   * @throws IllegalStateException If the iterator has not been opened
   */
  Tuple next() throws DbException, TransactionAbortedException, NoSuchElementException, IOException;
