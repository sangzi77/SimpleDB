...
public class BTreeHeaderPage implements Page {
	...
	final BTreePageId pid;//记录目标页面的pageId
	final byte[] header;//储存slot使用情况
	final int numSlots;//叶节点中最多能存储指针的数量

	private int nextPage; // 指向下一个 headerPage，为0则为空。
	private int prevPage; //指向上一个 headerPage，为0则为空。
