...
public class TupleDescTest extends SimpleDbTestBase {
    ...
    @Test public void combine() {
        ...
        td1 = Utility.getTupleDesc(1, "td1");//1个Int类型的td1字段
        td2 = Utility.getTupleDesc(2, "td2");//2个Int类型的td2字段

        // test td1.combine(td2)
        td3 = TupleDesc.merge(td1, td2);
        assertEquals(3 , td3.numFields()); //断言两个对象相等，如果不相等的话抛出异常
     ...
     * 确保combined的字段名=td1的字段名+td2的字段名
     */
